...
from blueprints.browse_animals import *
...
app.register_blueprint(login_page_bp)                    # /login
...
# Register browse animal blueprints
app.register_blueprint(animal_details_bp)                # /animal_details/<int: animal_id>
app.register_blueprint(browse_animals_bp)                # /browse_animals
